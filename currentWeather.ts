// To parse this data:
//
//   import { Convert, CurrentWeather } from "./file";
//
//   const currentWeather = Convert.toCurrentWeather(json);
//
...
export class Convert {
    public static toCurrentWeather(json: string): CurrentWeather {
        return cast(JSON.parse(json), r("CurrentWeather"));
    }

    public static currentWeatherToJson(value: CurrentWeather): string {
        return JSON.stringify(uncast(value, r("CurrentWeather")), null, 2);
    }
}
